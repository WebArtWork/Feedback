...
angular.module("wcom_mongo", []).service('mongo', function($http, $timeout, socket){
	...
	*	mongo sort filters
	*/
   		this.sortAscId = function(next){
   			return function(a,b){
   				if(a._id>b._id) return 1;
   				if(a._id<b._id || typeof next != 'function') return -1;
   				else return next(a,b);
   			}
   		};
   		this.sortDescId = function(next){
   			return function(a,b){
   				if(a._id<b._id) return 1;
   				if(a._id>b._id || typeof next != 'function') return -1;
   				else return next(a,b);
	...
	*/
		...
		var push = function(part, doc) {
			...
			if(typeof data['opts' + part].sort == 'function') {
...
.service('modal', function($compile, $rootScope){
	...
	"ngInject";
	return {
		restrict: 'E', templateUrl: 'wmodal_modal.html',
		transclude: true, scope: {
			id: '@'
		}, link: modal.modal_link
	};
